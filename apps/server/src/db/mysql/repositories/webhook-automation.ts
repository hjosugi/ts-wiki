...
/** MySQL implementation of the driver-neutral webhook-automation contract. */
export const createMysqlWebhookAutomationRepository = (db: MysqlDb): WebhookAutomationRepository => ({
