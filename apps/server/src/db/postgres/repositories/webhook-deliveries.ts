...
/** PostgreSQL implementation of the driver-neutral webhook-delivery contract. */
export const createPostgresWebhookDeliveryRepository = (db: PostgresDb): WebhookDeliveryRepository => ({
  async findById(id) {
